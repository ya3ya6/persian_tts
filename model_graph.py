...
class model(object):
    def __init__(self, data_path,mode):
        ...
        if mode=='training_superresolution':
            ...
            with tf.compat.v1.variable_scope('Super_Resolution_Network'):
        ...
        if mode=='training_text2sp':
            ...
            with tf.compat.v1.variable_scope("Text_Encoder"):
            ...
            with tf.compat.v1.variable_scope("Audio_Decoder"):
        ...
        if mode=='training_superresolution' or mode=='training_text2sp':    
            with tf.compat.v1.variable_scope('Loss_Operations'):
                if mode=='training_text2sp':
                    # mel L1 loss
